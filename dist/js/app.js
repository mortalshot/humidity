(() => {
    ...
    function initSliders() {
        if (document.querySelector(".template5__slider")) new core(".template5__slider", {
...
***************************************************************************** */
    ...
    if (template7Gallery) new Masonry(template7Gallery, {
    ...
    function gsapAnimations() {
        ...
        if (template1) {
            ...
            if (template1Bg) template1LeftTimeline.from(template1Bg, {
                opacity: 0,
                scale: 1.5,
                filter: "blur(15px)",
                duration: 2,
            ...
            if (template1Title) template1LeftTimeline.from(template1Title, {
                opacity: 0,
                xPercent: -100,
                duration: .5,
                ease: "power2.out"
            }, "-=1.5");
            if (template1TextContent) template1LeftTimeline.from(template1TextContent, {
                opacity: 0,
                yPercent: 100,
                duration: .5,
                ease: "power2.out"
            }, "-=1");
            if (template1TextLink) template1LeftTimeline.from(template1TextLink, {
                opacity: 0,
                xPercent: 100,
                duration: .5,
                ease: "power2.out"
            ...
            if (template1Right && window.innerWidth > 767.98) {
                ...
                captionWords.forEach((element => {
                    ...
                    let j = 0;
                    words.forEach((word => {
                        if (j % 2 == 0) template1LeftTimeline.from(word, {
                            yPercent: 100,
                            duration: .5,
                            ease: "power2.out"
                        }); else template1LeftTimeline.from(word, {
                            yPercent: -100,
                            duration: .5,
                            ease: "power2.out"
                        });
                    ...
                    if (element != captionWordsLastElement) {
                        ...
                        words.forEach((word => {
                            let yPercent;
                            if (j % 2 == 0) yPercent = -100; else yPercent = 100;
            ...
            if (template1Features.length > 0) template1Features.forEach((element => {
        ...
        if (template2) {
            ...
            if (template2Items.length > 0) {
                ...
                template2Items.forEach((element => {
                    if (j % 2 == 0) elementTimeline.from(element, {
                        opacity: 0,
                        yPercent: 10,
                        duration: .75,
                        ease: "power2.out"
                    }, "-=0.1"); else elementTimeline.from(element, {
                        opacity: 0,
                        yPercent: -10,
                        duration: .75,
                        ease: "power2.out"
                ...
                if (template2Words.length > 0) template2Words.forEach((element => {
                        ...
                        template3Cards.forEach(((card, index) => {
                            ...
                            if (1 === opacityValues[index]) {
                                ...
                                if (card.classList.contains("template3-layout1")) {
                                    ...
                                    if (template3Layout1Logo) if (progressPercentage > 50) {
                                        if (index != numCards - 1) gsap.to(template3Layout1Logo, {
                                            opacity: `${1 - progressPercentage / 100}`
                                        });
                                    } else gsap.to(template3Layout1Logo, {
                                        opacity: 1
                                    });
                                }
                                if (card.classList.contains("template3-layout2")) {
                                    ...
                                    if (template3Layout2Text) {
                                        if (progressPercentage < 25) gsap.to(template3Layout2Text, {
                                            opacity: `${4 * progressPercentage / 100}`,
                                            xPercent: `${4 * progressPercentage - 100}`
                                        });
                                        if (progressPercentage > 75) gsap.to(template3Layout2Text, {
                                            opacity: `${(100 - progressPercentage) / 100}`,
                                            xPercent: `${1.333 * progressPercentage - 100}`
                                        });
                                    }
                                }
                                if (card.classList.contains("template3-layout3")) {
                                    ...
                                    if (progressPercentage < 20) if (template3Layout3Image) gsap.to(template3Layout3Image, {
                                        opacity: `${5 * progressPercentage / 100}`,
                                        xPercent: `${5 * progressPercentage - 100}`
                                    });
                                    if (progressPercentage < 30) if (template3Layout3Text) gsap.to(template3Layout3Text, {
                                        opacity: `${3.333 * progressPercentage / 100}`,
                                        xPercent: `${3.333 * progressPercentage - 100}`
                                    });
                                    if (progressPercentage > 70) {
                                        if (template3Layout3Image) {
                                            const imageWidth = template3Layout3Image.offsetWidth;
                                            const windowWidth = window.innerWidth;
                                            gsap.to(template3Layout3Image, {
                                                scaleX: windowWidth * (progressPercentage / 100) / imageWidth * (progressPercentage / 100),
                                                scaleY: windowWidth * (progressPercentage / 100) / imageWidth * (progressPercentage / 100)
                                            });
                                        }
                                        if (template3Layout3Text) gsap.to(template3Layout3Text, {
                                            opacity: `${(100 - progressPercentage) / 100}`,
                                            xPercent: `${20}`
                                        });
                                    } else if (progressPercentage < 70 && progressPercentage > 20) {
                                        if (template3Layout3Image) gsap.to(template3Layout3Image, {
                                            scaleX: 1,
                                            scaleY: 1
                                        });
                                        if (progressPercentage > 30) if (template3Layout3Text) gsap.to(template3Layout3Text, {
                                ...
                                if (card.classList.contains("template3-layout4")) {
                                    ...
                                    if (progressPercentage < 25) {
                                        if (template3Layout4Image) gsap.to(template3Layout4Image, {
                                            opacity: `${4 * progressPercentage / 100}`,
                                            scale: `${.04 * progressPercentage}`
                                        });
                                        if (template3Layout4Text) gsap.to(template3Layout4Text, {
                                            opacity: `${4 * progressPercentage / 100}`,
                                            xPercent: `${4 * progressPercentage - 100}`
                                        });
                                    }
                                    if (progressPercentage > 70) {
                                        if (template3Layout4Image) {
                                            template3Layout4Image.querySelector("#template3-layout4-object-1");
                                            gsap.to(template3Layout4Image, {
                                                scaleX: 3 * (progressPercentage / 100),
                                                scaleY: 3 * (progressPercentage / 100)
                                            });
                                        }
                                        if (template3Layout4Text) gsap.to(template3Layout4Text, {
                                            opacity: `${(100 - progressPercentage) / 100}`,
                            ...
                            } else card.classList.remove("_active-card");
                            if (1 == self.progress) {
        ...
        if (template4) {
            ...
            if (template4Items.length > 0) {
                ...
                template4Items.forEach((element => {
                    ...
                    if (elementTitle) {
                        let xPercent;
                        if (j % 2 == 0) xPercent = -10; else xPercent = 10;
                    ...
                    if (elementImageThumb) elementTimeline.to(elementImageThumb, {
                        yPercent: -100,
                        height: 0,
                        duration: 1.5,
                        ease: "power2.out"
        ...
        if (template5Slide) {
            ...
            if (slideImageThumb) slideImageThumbTimeline.to(slideImageThumb, {
                yPercent: -100,
                height: 0,
                duration: 1.5,
                ease: "power2.out"
        ...
        if (template6Items.length > 0) template6Items.forEach((element => {
            ...
            if (elementBody) elementTimeline.from(elementBody, {
                opacity: 0,
                yPercent: 5,
                duration: .75,
                ease: "power2.out"
            }, "-=1");
            if (elementSpace) elementTimeline.from(elementSpace, {
                opacity: 0,
                yPercent: 5,
                duration: .75,
                ease: "power2.out"
            }, "-=0.75");
            if (elementLetter) elementTimeline.from(elementLetter, {
                opacity: 0,
                yPercent: 5,
                duration: .75,
                ease: "power2.out"
        ...
        if (template7Items.length > 0) template7Items.forEach((element => {
            const elementTimeline = gsap.timeline({
                scrollTrigger: {
                    trigger: element,
                    start: "top 80%",
        ...
        if (seoText.length > 0) seoText.forEach((element => {
            const elementTimeline = gsap.timeline({
                scrollTrigger: {
                    trigger: element,
                    start: "top 80%",
        ...
        if (footer && window.innerWidth > 767.98) {
            ...
            if (footerBottomBg) footerBottomTimeline.from(footerBottomBg, {
                opacity: 0,
                scale: 1.5,
                filter: "blur(15px)",
                duration: 2,
            ...
            if (captionWords.length > 0) captionWords.forEach((element => {
                ...
                if (element != captionWordsLastElement) {
                    j = 0;
                    words.forEach((word => {
                        if (j % 2 == 0) footerBottomTimeline.to(word, {
                            xPercent: -100,
                            opacity: 0,
                            duration: .5,
                            ease: "power2.out"
                        }); else footerBottomTimeline.to(word, {
                            xPercent: 100,
                            opacity: 0,
                            duration: .5,
                            ease: "power2.out"
            ...
            if (footerBottomRow) footerBottomTimeline.from(footerBottomRow, {
                opacity: 0,
                yPercent: 10,
                duration: .5,
                ease: "power2.out"
        ...
        if (template8) {
            template8.querySelector(".template8__row");
            ...
            if (template8Media) template8Timeline.from(template8Media, {
                opacity: 0,
                duration: .5,
                ease: "power2.out"
            });
            if (template8Main) template8Timeline.from(template8Main, {
                opacity: 0,
                xPercent: 100,
                duration: .5,
                ease: "power2.out"
        ...
        if (template9Items.length > 0) template9Items.forEach((element => {
            const elementImageThumb = element.querySelector(".image-thumb");
            ...
            if (elementLine) elementTimeline.from(elementLine, {
                opacity: 0,
                duration: .75,
                ease: "power2.out"
            }, "-=1");
            if (elementMain) elementTimeline.from(elementMain, {
                opacity: 0,
                duration: .75,
                ease: "power2.out"
            }, "-=1");
        ...
        if (template10Items.length > 0) template10Items.forEach((element => {
            const elementTimeline = gsap.timeline({
                scrollTrigger: {
                    trigger: element,
                    start: "top 80%",
        ...
        if (template11Items.length > 0) template11Items.forEach((element => {
            const elementTimeline = gsap.timeline({
                scrollTrigger: {
                    trigger: element,
                    start: "top 80%",
        ...
        if (template15Items.length > 0) template15Items.forEach((element => {
            ...
            if (elementImageThumb) elementRowTimeline.to(elementImageThumb, {
                yPercent: -100,
                height: 0,
                duration: 1.5,
                ease: "power2.out"
        ...
        if (template16) {
            ...
            if (template16Words.length > 0) template16Words.forEach((element => {
                template16Timeline.from(element, {
                    opacity: 0,
                    duration: .5,
                    ease: "power2.out"
        ...
        if (articlesItems.length > 0) {
            articlesItems.forEach((element => {
                ...
                if (elementImageBody) articlesItemsTimeline.from(elementImageBody, {
                    opacity: 0,
                    duration: .5,
                    ease: "power2.out"
                }, "-0.5");
